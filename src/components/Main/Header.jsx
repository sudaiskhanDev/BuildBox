...
import LoginModal from "./LoginModal"; // tumhara existing login modal
...
const Header = () => {
  ...
  const handleButtonClick = () => {
    if (isLoggedIn) {
      window.location.href = "/Input"; // logged-in user -> redirect
    } else {
      setLoginModalOpen(true); // not logged-in -> show login modal
    }
  };
