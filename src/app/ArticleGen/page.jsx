...
const page = () => {
  return ( 
    ...
    <div className='bg-black h-screen flex justify-center items-center'>
        <div className="main-input-output w-[90%] md:w-[80%] max-w-4xl h-[800px] mx-auto mt-12 mb-8 rounded-2xl shadow-lg overflow-hidden flex flex-col border bg-gray-500 border-gray-900">
        {/* Output Section */}
        <div className="output-section flex-grow p-6 overflow-y-auto bg-gray-700">
        ...
        {/* Input Section */}
        <div className="input-section w-full h-[150px] bg-gray-700 flex justify-center items-center p-4">
            <div className="input-text-btn w-full sm:w-[80%] md:w-[60%] h-[60px] bg-[#8a8a8a] rounded-full shadow-md flex items-center px-2">
